...
public class USER_WINDOW extends JFrame {
    ...
    public USER_WINDOW(TOOLS tools) {
        super("USER_WINDOW");
        ...
        jButton_Add.addActionListener(new TOOLS.WINDOW_JButton_LINSTENER(textField_id, textField_password, textField_name, textField_gender, textField_age, textField_phone_number, textField_address, textField_email, textField_level, jScrollPane, jLabel, jButton_Add.getText(), "user_information", tools));
        jButton_Delete.addActionListener(new TOOLS.WINDOW_JButton_LINSTENER(textField_id, textField_password, textField_name, textField_gender, textField_age, textField_phone_number, textField_address, textField_email, textField_level, jScrollPane, jLabel, jButton_Delete.getText(), "user_information", tools));
        jButton_Modify.addActionListener(new TOOLS.WINDOW_JButton_LINSTENER(textField_id, textField_password, textField_name, textField_gender, textField_age, textField_phone_number, textField_address, textField_email, textField_level, jScrollPane, jLabel, jButton_Modify.getText(), "user_information", tools));
        jButton_Search.addActionListener(new TOOLS.WINDOW_JButton_LINSTENER(textField_id, textField_password, textField_name, textField_gender, textField_age, textField_phone_number, textField_address, textField_email, textField_level, jScrollPane, jLabel, jButton_Search.getText(), "user_information", tools));
        jButton_Fuzzy_query.addActionListener(new TOOLS.WINDOW_JButton_LINSTENER(textField_id, textField_password, textField_name, textField_gender, textField_age, textField_phone_number, textField_address, textField_email, textField_level, jScrollPane, jLabel, jButton_Fuzzy_query.getText(), "user_information", tools));
    ...
    public void visible(TOOLS tools) {
        setVisible(tools.page.equals("USER_WINDOW"));
    }
}
